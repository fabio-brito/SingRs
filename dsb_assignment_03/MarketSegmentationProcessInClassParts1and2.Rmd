...
1 - Statistically, the elbow for the plot of distances can be observed around 5 and 6 segments. Beyond that, the distances are not signifcation to justify the creation of more clusters. Interpretation and business wise, we attempted clustering with 3, 4, 5, and 6 segments and found that 5 segments present the most cohesive picture in terms of deferring attitudes and motivations towards boating.  

2 -
OBS: Segment letter is not tied to the segment numbers, since they rotate every time the document is Knit 
Segment E: They see themselves as experts in terms of boat experience (Q8), the own or a looking for boats with higher HP (Q5), and will probably buy a new boat in the future (Q3)
