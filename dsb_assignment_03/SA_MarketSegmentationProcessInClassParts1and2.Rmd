...
#At this stage, these are factors (or product dimensions) - not segments. A unique mix of factors can lead to segment discovery. Suggested: 1 - Prestige; 2 - Adventure; 3 - Reliability; 4 - Maintainability; 5 - Economy  

1 - Factor 1 indicates highly brand- conscious customers who view their boat as a status symbol. Factor 2 indicates outdoor enthusiasts who enjoy active lifestyle. Factor 3 indicates customers who value convenience and reliability which they seek in a high-quality reputable product. The factors make business sense as they indicate observable attributes and benefits that customers seek from their boats.

2 - Having used eigenvalues, 3 variations in the manual settings, and minimum variance-explained threshold of 20% and 5%, we conclude that eigenvalues provide strongest statistical, business and interpretatuve arguments for factor selection criteria. On the basis of of eigenvalues we conclude there are 5 different factors explaining 52.74% of the cumulative variance in the dataset.

3 - Data science provides us with statistically robust tools to classify and consume information. The interpretation of the results however should be based on business acumen and how actionable (e.g., whether the factorization allows us to identify and target mutually exclusive customer segments for an optimal allocation of resources) the insights from the data are.  
