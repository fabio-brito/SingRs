...
# CCDdata_A$BILL_AMT1 <- as.integer(CCDdata_A$BILL_AMT1)
# CCDdata_A$BILL_AMT2 <- as.integer(CCDdata_A$BILL_AMT2)
# CCDdata_A$BILL_AMT3 <- as.integer(CCDdata_A$BILL_AMT3)
# CCDdata_A$BILL_AMT4 <- as.integer(CCDdata_A$BILL_AMT4)
# CCDdata_A$BILL_AMT5 <- as.integer(CCDdata_A$BILL_AMT5)
# CCDdata_A$BILL_AMT6 <- as.integer(CCDdata_A$BILL_AMT6)
# 
# CCDdata_A$PAY_AMT1 <- as.integer(CCDdata_A$PAY_AMT1)
# CCDdata_A$PAY_AMT2 <- as.integer(CCDdata_A$PAY_AMT2)
# CCDdata_A$PAY_AMT3 <- as.integer(CCDdata_A$PAY_AMT3)
# CCDdata_A$PAY_AMT4 <- as.integer(CCDdata_A$PAY_AMT4)
# CCDdata_A$PAY_AMT5 <- as.integer(CCDdata_A$PAY_AMT5)
# CCDdata_A$PAY_AMT6 <- as.integer(CCDdata_A$PAY_AMT6)
...
# CCDdata_B$BILL_AMT1 <- as.integer(CCDdata_B$BILL_AMT1)
# CCDdata_B$BILL_AMT2 <- as.integer(CCDdata_B$BILL_AMT2)
# CCDdata_B$BILL_AMT3 <- as.integer(CCDdata_B$BILL_AMT3)
# CCDdata_B$BILL_AMT4 <- as.integer(CCDdata_B$BILL_AMT4)
# CCDdata_B$BILL_AMT5 <- as.integer(CCDdata_B$BILL_AMT5)
# CCDdata_B$BILL_AMT6 <- as.integer(CCDdata_B$BILL_AMT6)
# 
# CCDdata_B$PAY_AMT1 <- as.integer(CCDdata_B$PAY_AMT1)
# CCDdata_B$PAY_AMT2 <- as.integer(CCDdata_B$PAY_AMT2)
# CCDdata_B$PAY_AMT3 <- as.integer(CCDdata_B$PAY_AMT3)
# CCDdata_B$PAY_AMT4 <- as.integer(CCDdata_B$PAY_AMT4)
# CCDdata_B$PAY_AMT5 <- as.integer(CCDdata_B$PAY_AMT5)
# CCDdata_B$PAY_AMT6 <- as.integer(CCDdata_B$PAY_AMT6)
