...
pacman::p_load("xlsx","caret","ROCR","lift","glmnet","MASS","e1071", "randomForest", "xgboost", "party", "partykit","ROCR","lift","rpart","e1071", "readxl") 
```

```{r data_loading}
library("readxl")
read.exc
CCDdata_A<-read.excel("DSB A2 -- credit data.xlsx", sheet = 1) # Load the datafile to R
